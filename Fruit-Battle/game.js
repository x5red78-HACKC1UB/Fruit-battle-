...
let playerHue = 0; // color flashy flash
let cMoveActive = false;
let cMoveTimer = 0; // c move timer
let orbitCircles = [];
...
if (key === 'c' && soundSelected) {
  ...
  for (let i = 0; i < 4; i++) {
    orbitCircles.push({
      ...
      speed: 0.35   // spinny circle go 
    });
  }
}
